            ...
            <div className="container flex h-14 items-center max-lg:px-5">
                ...
                <div 
                    className={clsx(
                        ...
                        isOpen ? "max-lg:opacity-100" : "max-lg:opacity-0 max-lvite-prog:pointer-events-none"
                    )}
                >
                    <div className=" max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 sidebar-before ">
                        <nav className="  max-lg:z-2 max-lg:my-auto">
                            <ul className="flex max-lg:block max-lg:px-12">
                                ...
                                <li className="nav-logo">
                                    <LinkScroll 
                                        to="hero"
                                        offset={-100} spy smooth className={clsx (
                        ...
                        <div className="lg:hidden block absolute top-1/2 right-7 w-[1000px] h-[400px] trranslate-x-[-290px] -translate-y-1/2 rotate-90">
